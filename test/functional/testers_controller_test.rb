...
class TestersControllerTest < ActionController::TestCase
  ...
  test "should create tester" do
    assert_difference('Tester.count') do
      post :create, tester: { Address: @tester.Address, Firstname: @tester.Firstname, Lastname: @tester.Lastname, score: @tester.score }
    end
  ...
  test "should update tester" do
    put :update, id: @tester, tester: { Address: @tester.Address, Firstname: @tester.Firstname, Lastname: @tester.Lastname, score: @tester.score }
    assert_redirected_to tester_path(assigns(:tester))
  end
