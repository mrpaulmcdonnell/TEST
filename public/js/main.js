...
$(document).ready(function() {
    ...
    var start_questions = function(){
        var questions = [
            { "text":"Question 1: The maximum permissible speed for cars or motorcycles on motorways M1 is?", "answers":["60km/h", "80km/h", "100km/h", "120km/h"], "correct":"120km/h" },
    ...
    var display_message = (function () {
        if (score > 5){
            message  = "Congratulations, you have passed the test. Please <a href='/testers/new'>click here</a> to fill your details.";
        $("#message").html(message);
